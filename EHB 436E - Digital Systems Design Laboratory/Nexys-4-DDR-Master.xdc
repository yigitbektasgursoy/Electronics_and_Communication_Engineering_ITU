...
#set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { addra[2] }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
#set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { addra[3] }]; #IO_L13N_T2_MRCC_14 Sch=sw[3]
...
##f1 LUTS
#set_property LOC SLICE_X12Y66 [get_cells xorF1_0/*]
##f2 LUT
#set_property LOC SLICE_X13Y67 [get_cells f2_OBUF_inst_i_1]
##f3 LUT
#set_property LOC SLICE_X14Y64 [get_cells f3_OBUF_inst_i_1]


#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets Qn_OBUF]

set_max_delay -from [get_ports {clk res x}] -to [get_ports Z] 4.000
